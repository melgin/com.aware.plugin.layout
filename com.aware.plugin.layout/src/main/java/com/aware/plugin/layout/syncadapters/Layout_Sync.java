package com.aware.plugin.layout.syncadapters;
...
import com.aware.plugin.layout.Provider;
 ...
 */
public class Layout_Sync extends Service {
        ...
        synchronized (sSyncAdapterLock) {
            if (sSyncAdapter == null) {
                ...
                sSyncAdapter.init(
                        ...
                        new Uri[]{
                                Provider.Layouts_Data.CONTENT_URI
                        }
                );
            }
        }
